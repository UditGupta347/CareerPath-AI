  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute -top-40 -right-40 w-96 h-96 bg-gradient-to-br from-indigo-200/40 to-violet-200/40 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, -50, 0],
        ...
        className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-cyan-200/40 to-blue-200/40 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          x: [0, 50, 0],
